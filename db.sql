...
CREATE TABLE `users`(
    `id` BIGINT(20) AUTO_INCREMENT PRIMARY KEY,                     -- 用户id
    `name` VARCHAR(32) COLLATE utf8_bin NOT NULL,                   -- 用户昵称
    `password` VARCHAR(64) COLLATE utf8_bin NOT NULL,               -- 用户密码
    `avatar` VARCHAR(500) COLLATE utf8_bin NOT NULL,                -- 用户头像地址
    `gender` ENUM('男', '女', '其他'),                              -- 用户性别
    `phone` VARCHAR(11) COLLATE utf8_bin NOT NULL,                  -- 用户手机号
    `location` VARCHAR(200) CHARACTER SET utf8mb4 DEFAULT NULL      -- 用户地址
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


DROP TABLE IF EXISTS `messages`;
CREATE TABLE `messages`(
    `id` BIGINT(20) AUTO_INCREMENT PRIMARY KEY,                     -- 消息id
    `sender_id` BIGINT(20) NOT NULL,                                -- 发送者id
    `receiver_id` BIGINT(20) NOT NULL,                              -- 接收者id
    `content` TEXT NOT NULL,                                        -- 消息内容
    `created_at` TIMESTAMP DEFAULT NOW(),                           -- 消息接收（创建）时间
    `is_read` BOOLEAN DEFAULT FALSE,                                -- 是否阅读
...
CREATE TABLE `notifications`(
    `id` BIGINT(20) AUTO_INCREMENT PRIMARY KEY,                     -- 通知id
    `user_id` BIGINT(20) NOT NULL,                                  -- 用户id
    `message` TEXT NOT NULL,                                        -- 通知内容
    `create_at` TIMESTAMP DEFAULT NOW(),                            -- 通知接收（创建）时间
    `is_read` BOOLEAN DEFAULT FALSE,                                -- 是否阅读
...
CREATE TABLE `favorites`(
    `user_id` BIGINT(20) NOT NULL,                                  -- 用户id
    `item_type` ENUM('article', 'product', 'video') NOT NULL,       -- 收藏内容类型
    `item_id` BIGINT(20) NOT NULL,                                  -- 内容id
    `create_at` TIMESTAMP DEFAULT NOW(),                            -- 收藏时间
    FOREIGN KEY (`user_id`) REFERENCES `users`(`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

DROP TABLE IF EXISTS `articles`;
CREATE TABLE `articles`(
    `id` BIGINT(20) AUTO_INCREMENT PRIMARY KEY,                     -- 文章id
    `user_id` BIGINT(20) NOT NULL,                                  -- 作者id
...
CREATE TABLE `videos`(
    `id` BIGINT(20) AUTO_INCREMENT PRIMARY KEY,                     -- 视频id
    `user_id` BIGINT(20) NOT NULL,                                  -- 作者id
    `content` VARCHAR(500) COLLATE utf8_bin NOT NULL,               -- 内容地址
    FOREIGN KEY (`user_id`) REFERENCES `users`(`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `children`(
    ...
    `avatar` VARCHAR(500) COLLATE utf8_bin NOT NULL,
...
DROP TABLE IF EXISTS `health_data_collection`;                      
CREATE TABLE `health_data_collection`(
    `child_id` BIGINT(20) NOT NULL,                                 -- 孩子id
    `blood_pressure_systolic` TINYINT DEFAULT NULL,                 -- 血压收缩压
    `blood_pressure_diastolic` TINYINT DEFAULT NULL,                -- 血压舒张压
    `blood_sugar` DECIMAL(5, 2) DEFAULT NULL,                       -- 血糖
    `heart_rate` TINYINT DEFAULT NULL,                              -- 心率
    `oxygen_level` DECIMAL(4, 2),                                   -- 血氧
    `blood_type` VARCHAR(5),                                        -- 血型
    `nutrition_input` TEXT,                                         -- 营养摄入
...
CREATE TABLE `visual`(
    `child_id` BIGINT(20) NOT NULL,                             -- 孩子id
    `vision_left` DECIMAL(4, 2) DEFAULT NULL,                   -- 左眼视力
    `vision_right` DECIMAL(4, 2) DEFAULT NULL,                  -- 右眼视力
    `astigmatism_left` BOOLEAN DEFAULT FALSE,                   -- 左眼是否散光
    `astigmatism_right` BOOLEAN DEFAULT FALSE,                  -- 右眼是否散光
    FOREIGN KEY (`child_id`) REFERENCES `children`(`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `oral_cavity`(
    `child_id` BIGINT(20) NOT NULL,                             -- 孩子id
    `deciduous_teeth_count` TINYINT DEFAULT NULL,               -- 乳牙数
    `permanent_teeth_count` TINYINT DEFAULT NULL,               -- 恒牙数
    `wisdom_teeth_count` TINYINT DEFAULT NULL,                  -- 智齿数
    FOREIGN KEY (`child_id`) REFERENCES `children`(`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- -----------------
-- 内分泌？运功系统？耳鼻喉？呼吸系统？交互？
-- -----------------
...
VALUES
	(4,1,'二师兄','010','18688888888','yb','yb','翠萍区','ybut恐龙大楼','100000','2000-01-22 14:26:25','2000-01-22 14:26:25');
