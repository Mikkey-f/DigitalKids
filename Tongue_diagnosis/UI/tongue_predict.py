...
from Tongue_diagnosis.effcient_Net.tongue_coated.coated_predict import main as coater_predict
from Tongue_diagnosis.effcient_Net.tongue_color.color_predict import main as color_predict
from Tongue_diagnosis.effcient_Net.tongue_crack.crack_predict import main as crack_predict
from Tongue_diagnosis.effcient_Net.tongue_indentation.indent_predict import main as indent_predict
if __name__ == '__main__':
    img_path = "D:/Tongue/TongueDiagnosis1/TongueDiagnosis/Tongue_diagnosis/data/test/12.png"
    font = FontProperties(fname='D:/Tongue/TongueDiagnosis1/TongueDiagnosis/Tongue_diagnosis/msyhbd.ttc')
