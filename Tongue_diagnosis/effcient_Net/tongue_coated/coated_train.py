...
def main(args):
    ...
    print(args)
    print('Start Tensorboard with "tensorboard --logdir=effcient_Net/tongue_coated/runs", view at http://localhost:6006/')
    ...
    data_transform = {
        "train": transforms.Compose([transforms.RandomResizedCrop(img_size[num_model]),
                                     ...
                                     transforms.ToTensor(),
                                     transforms.Normalize([0.226,0.173,0.170], [0.287,0.231,0.233])]),
