...
def main(args):
    ...
    print(args)
    print('Start Tensorboard with "tensorboard --logdir=effcient_Net/tongue_crack/runs", view at http://localhost:6006/')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="../../data/tongue_crack")
