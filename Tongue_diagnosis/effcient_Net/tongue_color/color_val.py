...
def main(args):
    ...
    print(args)
    print('Start Tensorboard with "tensorboard --logdir=effcient_Net/tongue_color/runs", view at http://localhost:6006/')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="../../data/tongue_color")
    parser.add_argument('--weights', type=str, default='./weights/1model-24.pth',
